...
<div style="display:flex;min-height:100vh;background:#0f1319;color:#e7ebf0;font-family:'IBM Plex Sans',system-ui,sans-serif;-webkit-font-smoothing:antialiased">

    {{-- SIDEBAR --}}
    <aside style="width:266px;flex:none;position:sticky;top:0;height:100vh;overflow-y:auto;background:#0b0f16;border-right:1px solid rgba(255,255,255,.07);padding:26px 16px 22px;display:flex;flex-direction:column">
        <a href="{{ route('objecion-cero.inicio') }}" wire:navigate style="display:flex;flex-direction:column;gap:2px;padding:4px 8px 0">
    ...
    <main style="flex:1;height:100vh;overflow-y:auto">
        <div style="max-width:1120px;margin:0 auto;padding:0 48px 90px">
            {{ $slot }}
        </div>
    </main>
